...
print("\n" + "🛡️" * 50)
print("🚀 BANK FRAUD AGENT - LALIT'S EDITION INITIALIZED")
...
async def lookup_customer(
    ...
    try:
        ...
        found_record = next(
            (item for item in data if item["userName"].lower() == name.lower()),
            None
        )
        ...
        if found_record:
            ...
            return (
                ...
                "Instructions: Ask the user for their 'Security Identifier' to verify identity "
...
async def entrypoint(ctx: JobContext):
    ...
    print("\n" + "💼" * 25)
    print("🚀 STARTING FRAUD ALERT SESSION - LALIT'S EDITION")
