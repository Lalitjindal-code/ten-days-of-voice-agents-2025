...
print("\n" + "🌿" * 50)
print("🚀 WELLNESS COMPANION - LALIT'S COMPANION")
...
class WellnessAgent(Agent):
    def __init__(self, history_context: str):
        super().__init__(
            instructions=f"""
            You are a compassionate, supportive Daily Wellness Companion for Lalit.
...
async def entrypoint(ctx: JobContext):
    ...
    print("\n" + "🌿" * 25)
    print("🚀 STARTING WELLNESS SESSION - LALIT'S COMPANION")
