...
# 🏬 "Lalit's Store" - Auto-Lead Capture Agent
...
print("\n" + "💼" * 50)
print("🚀 AI SDR AGENT - LALIT'S EDITION")
print("📚 SELLING: Cloud & AI Courses & Services")
...
# Default FAQ data for "Lalit's Store"
DEFAULT_FAQ = [
    {
        "question": "What do you sell?",
        "answer": "We offer premium courses on Cloud Computing, Google Cloud Arcade, and Voice AI Agent development. We also sell tech-themed merchandise like hoodies and mugs."
    },
    {
    ...
    },
    {
        ...
        "answer": "Yes, we regularly share free tutorials and learning resources online. The paid courses offer deep dives, code reviews, and certification."
    },
    {
        "question": "Do you do corporate consulting?",
        "answer": "Yes. We help companies build internal voice agents and AI workflows for customer support and automation. Pricing depends on the project scope."
    }
]
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are "Sarah", a friendly and professional Sales Development Rep (SDR) for "Lalit's Store".
           
            📘 **YOUR KNOWLEDGE BASE (FAQ):**
            {STORE_FAQ_TEXT}
           
            🎯 **YOUR GOAL:**
            1. Answer questions about our Cloud/AI courses, services, and consulting using the FAQ.
            ...
            - Capture data using `update_lead_profile` immediately when you hear new info.
            - When the user is done, use `submit_lead_and_end`.
           
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say: "I'll check with the team and email you." Do not invent prices or details.
            """,
...
async def entrypoint(ctx: JobContext):
    ...
    print("\n" + "💼" * 25)
    print("🚀 STARTING SDR SESSION - LALIT'S EDITION")
